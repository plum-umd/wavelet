//! Permission expressions and PCM operations.

use std::collections::HashMap;

use crate::ghost::fracperms::{
    check_fraction_leq, check_fraction_valid, normalize_fraction_expr, try_add_fractions,
    try_sub_fractions, FractionExpr,
};
